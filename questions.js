...
{
  q: "While disclosing information about a customer, a bank should take precautions to ----- (1) give the detailed information about the customer's financial position without hiding any facts which are known to bank (2) only facts as are evident from the customer's account to be revealed (3) recipient should be advised that the bank is not responsible for the information so given.",
  o: [
    "(1) only",
    "(1) and (2) only",
    "(2) and (3) only",
...
{
  q: "RBI has made it mandatory for all Credit Information Companies in the country to provide Full Credit Report on request to individuals whose credit history is available......",
  o: [
...
{
  q: "The various features of Central Bank Digital Currency (Wholesale) include ------ (1) meant for financial institutions (2) for settlement of interbank transfers (3) for settlement of secondary market transactions in government securities (4) reduced transaction costs.",
  o: [
    "(1), (2) and (4) only",
    "(2), (3) and (4) only",
    "(1), (2), (3) and (4)",
...
{
  q: "A Business Facilitator will undertake the activities which include ....... (1) credit counselling (2) promotion and nurturing Self-Help Groups (SHGs)/Joint Liability Groups (JLGs) (3) follow-up for recovery (4) educating people and advising them on money.",
  o: [
    "(1) and (2) only",
    "(1), (2), (3) and (4)",
    "(3) only",
...
{
  q: "The Account Aggregator will replace many hassles for consumers today like ______. (1) sharing physical signed and scanned copies of bank statements (2) running around to notarise or stamping of documents (3) having to share personal username and password to give the financial history to a third party.",
  o: [
    "(1) and (2) only",
    "(1), (2) and (3)",
    "(2) and (3) only",
...
{
  q: "In the case of charge card, payment is made by the user ______.",
  o: [
    "at one go",
    "in instalments",
...
{
  q: "In the case of White Label ATMs ______.",
  o: [
...
{
  q: "The Jan Samarth Portal uses cutting-edge technologies and smart analytics to provide intuitive guidance to citizens ______. (1) for selecting most suitable loan scheme as per citizen's requirements and credentials (2) for checking subsidy (3) for checking eligibility.",
  o: [
    "(1) only",
    "(1) and (2) only",
    "(2) and (3) only",
...
{
  q: "Brown Label ATMs are ______.",
  o: [
    "meant for blind persons only where the key pad is in Braille",
    "meant only for coin dispensing",
    "those where hardware and lease of the ATM are owned by a service provider, but cash management and connectivity to banking network is offered by sponsor banks",
    "those where withdrawal can be made without any limit and it is meant for HNIs and business communities only"
  ],
  a: 2
},

{
  q: "Orange Label ATMs ______.",
  o: [
...

{
  ...
  o: [
    "In this system, banks can carry electronic identity verification using biometrics/OTP and obtain a digitally signed (by UIDAI) electronic identity document for storing within their system.",
    "In this system, a scanned copy of Aadhaar Card is submitted through the website of the concerned bank/insurance co./SEBI. Thereafter, there is no need to submit any paper physically for KYC purpose.",
    "In this system, the bank will simply get the Aadhaar Card number of the customer and submit the same to the UIDAI for verification of the documents which the customer has physically submitted to the bank.",
    "In this system, the customer will make a request to the UIDAI through email for submitting his details to the concerned bank/insurance co./SEBI."
  ],
  a: 0
},
{
...
{
  q: "Talks about ethics may include ____ (i) moral dependability (ii) punctuality of fulfilling obligations (iii) honouring the terms of contracts.",
  o: [
    "(ii) and (iii) only",
    "(i) and (iii) only",
    "(i), (ii) and (iii)",
...
{
  q: "The full maximum claim is not payable under Prime Minister Suraksha Bima Yojana by the general insurance company on death of the subscriber on account of _____.",
  o: [
    "Suicide",
    "Murder",
    "Accident",
...
{
  q: "Under PMJDY, it is to be ensured that banking facilities are available to all within a distance of _____.",
  o: [
    "12 K.M.",
    "10 K.M.",
    "5 K.M.",
...
{
  q: "Which of the following persons will not be eligible for being appointed as a Bank Mitra?",
  o: [
    "A retired teacher",
...
{
  q: "When shall the assurance on the life of the subscriber under Prime Minister Jeevan Jyoti Bima Yojana not be terminated/restricted?",
  o: [
    "Insufficiency of balance of the account as on the stipulated date.",
    "On attaining the age of 52 years (age nearer birthday).",
    "In case a subscriber is covered through more than one account, the total cover will be restricted to Rs. 2 lakh and the extra premium paid will be forfeited.",
    "Closure of the account in the bank."
  ],
  a: 1
},

{
  q: "What should be the age of subscribers under Atal Pension Yojana?",
  o: [
    "18 to 50 years",
    "18 to 60 years",
    "18 to 65 years",
...
{
  q: "The Depositor Education and Awareness Fund can be utilized by RBI _____.",
  o: [
    "For the promotion of depositors' interest",
    "Deposit Insurance",
    "Financial Inclusion",
    "None of the above"
  ],
...
{
  q: "To avail benefits of Direct Benefit Scheme, customer should approach the branch for linking the Aadhaar/UID number with the bank account number. In this regard, select the incorrect statement from the following.",
  o: [
    "The bank branch has to obtain written application along with copy of Aadhaar Card issued by UIDAI.",
    "In case of joint accounts, an application signed by both the applicants along with copies of their Aadhaar Cards should be obtained and link the account with both the Aadhaar numbers.",
    "The copies of Aadhaar cards must be verified by the branch and the same kept on record.",
    "It is compulsory."
  ],
  a: 3
},
...
{
  q: "Insurance benefits under Pradhan Mantri Jeevan Jyoti Bima Yojana (PMJJBY) is not available for death _____.",
  o: [
    "At the age of 54 years",
    "Occurring due to any reason except accident during the first 30 days from the date of re-enrolment into the scheme for those who exit the scheme at any point and re-join",
    "From heart attack within 90 days of enrolment into the scheme",
    "On account of any death within 45 days of enrolment into the scheme"
  ],
  a: 1
},
...
{
  q: "In case credit account in the name of ‘XYZ’ the interest has been debited regularly for 8 months but not paid, although the account is within the limit and drawing power. The account should be classified as:",
  o: [
    "Standard",
    "Sub-standard",
    "Doubtful",
...
{
  q: "USSD based Mobile Banking does not offer _____.",
  o: [
    "Money Transfer",
    "Bill Payments",
    "Merchant Payments",
...
{
  q: "Kisan Credit Card Scheme aims at _____.",
  o: [
    "Providing need based and timely credit support to farmers",
    "Providing credit to non-farm activities",
    "Providing credit in a flexible and cost-effective manner",
    "All of the above"
  ],
  a: 3
},
...
{
  q: "It is not expected that the Business Correspondent / Business Facilitator will perform the role of _____.",
  o: [
    "Companion",
    "Guide",
...
{
  q: "The delivery of Financial Education comprises of _____ (i) Face-to-face delivery (ii) Through Social Media (iii) Through Digital Vans (iv) Through Centres for Financial Literacy (CFLs).",
  o: [
    "(i) and (ii) only",
    "(ii) and (iii) only",
    "(iii) and (iv) only",
...

{
  ...
  o: [
    "Refuse to pay",
    "Make payment to 'B'",
    "Make payment to 'B' with concurrence of legal heirs of 'A'",
    "Make payment jointly to 'B' and legal heirs of 'A'"
  ],
  a: 1
},

{
  q: "The credit score given by a Credit Information Company, calculated through advanced analytics generally ranges from _____.",
  o: [
    "100 to 700",
    "200 to 800",
    "300 to 900",
...

{
  ...
  o: [
    ...
    "Determining the suitability of the activities chosen by a prospective borrower",
...
{
  q: "The features of Civil Society Organisations (CSOs) in the context of Financial Inclusion is _____.",
  o: [
    "NGOs",
...

{
  ...
  o: [
    "It can be used for P2M digital payments",
    "It is as secure as making a payment via UPI",
    "One can use any app that supports Bharat QR",
...
{
  q: "Financial statements include ____ (i) Balance Sheet (ii) Profit and Loss Account (iii) Accounting Policies (iv) Notes to the Accounts.",
  o: [
    "(i) only",
    "(i) and (ii) only",
    "(ii) and (iii) only",
...
{
  q: "Which one of the following is incorrect in the case of Near Field Communication (NFC) mobile contactless card technology?",
  o: [
    "Full traceability and audit trail of the transaction maintained",
    "Deposit and withdrawal transactions are instantly settled between the customer account and BC account as both accounts are in the same system",
...

{
  ...
  o: [
    ...
    "It is a method used for contactless smart cards",
...
{
  q: "The Kisan Credit Card beneficiaries can be issued _____ compatible for operation with ATMs / Micro ATMs / Handheld Devices.",
  o: [
    "Smart Card",
    "Debit Card",
    "General Credit Card",
...
{
  q: "\"99% service of banks can be availed by a customer _____.\"",
  o: [
...
{
  q: "Digital Rupee (e₹) may play a big role in _____.",
  o: [
...

{
  ...
  o: [
    "Income is recorded as per actual receipt whereas expenses are shown as per actual payment.",
...
{
  q: "A student has been sanctioned an Education Loan of Rs. 8 lakh for studies in India. What type of security can the bank demand to secure the loan?",
  o: [
    "No collateral security is needed.",
    "Only co-obligation of parents.",
    "Co-obligation of parents together with tangible collateral security / third-party guarantee.",
...
{
  q: "The concept of ethics may include ____ (i) a set of moral standards and values accepted by society (ii) guides human behaviour (iii) helps people from taking decisions that may harm others or the society (iv) its principles may differ according to the circumstances.",
  o: [
    "(i) only",
    "(i) and (ii) only",
    "(i), (ii) and (iii) only",
...
{
  q: "A Scheduled Bank enjoys certain special status which include ____ (i) availing refinance facilities from RBI (ii) becoming member of the Clearing House (iii) having currency chest facility.",
  o: [
    "(i) and (ii) only",
    "(i) and (iii) only",
    "(ii) and (iii) only",
...
{
  q: "Business Facilitator cannot do _____.",
  o: [
    "Handling of cash on behalf of the bank",
...
{
  q: "The area of operation of Regional Rural Banks (RRBs) is _____.",
  o: [
    "Restricted to one or more notified districts",
    "Restricted to one State only",
