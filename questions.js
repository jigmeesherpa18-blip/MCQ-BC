...
window.questions = [
{
  ...
  {
    q: "RBI has stipulated that banks should offer their savings bank customers free transactions at Bank's own Al Ms in a Metro City (Mumbai, New Delhi, Chennai, Kolkata, Bengaluru and Hyderabad) - in a month. (Select the most appropriate option from among the following.)",
    o: [
  ...
  {
    q: "In the case of charge card, payment is made by the user - (Select the most appropriate /the user-(Select the most apropr option from among the following com",
    o: [
      "At one go",
      "In instalments",
  ...
  {
    q: "The data received by an Account Aggregatoris, (Select the most appropriate option from among the following.) 100m",
    o: [
      "NBFC specific",
      "Bank specific",
  ...
  {
    q: "The Kisan Credit Card beneficiates can be issued - (Select the most appropriate option from among the following.)",
    o: [
      "Smart card",
      "Debit card",
      "General Credit Card",
  ...
  },
  {
    ...
    o: [
      ...
      "Inadequate arrangements made e to handle the volume of the work.",
      "Gap standards"
    ],
    a: 0
  },
  {
    q: "A bank will not disclose the affairs of the customer in the one of the following circumstances? (Select the most appropriate option from among the following)",
    o: [
